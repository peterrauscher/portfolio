...
*I actually built a Chrome extension to quickly check if a page has this hidden JSON data before I write a scraper. [It's on the Web Store](https://chromewebstore.google.com/detail/nextscraper/kjlhnflincmlpkgahnidgebbngieobod).*
